...
var app = (function () {
    ...
    function create_else_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			span = element("span");
    			span.className = "svelte-8xqa1c";
    			add_location(span, file$1, 66, 4, 1391);
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			li = element("li");
    			link.$$.fragment.c();
    			li.className = "svelte-8xqa1c";
    			add_location(li, file$1, 61, 8, 1296);
    		},
    ...
    function create_if_block_1$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			ul.className = "svelte-8xqa1c";
    			add_location(ul, file$1, 54, 12, 1100);
    			span.className = "HeaderLink svelte-8xqa1c";
    			toggle_class(span, "is-root", ctx.item.isRoot);
    			add_location(span, file$1, 52, 8, 1009);
    		},
    ...
    // (56:16) {#each item.items as item (item.id)}
    ...
    const {subscribe: subscribe$2, set: set$1, update: update$2} = writable([]);
    ...
    const BooksStore = () => ({
        ...
        async search(query) {
            try {
                error$1.set('');
                loading$1.set(true);
                const response = await axios$1.get(`${BASE_URL}/search.json?title=${query}`);
                loading$1.set(false);
                set$1(response.data.docs);
                return response.data;
            } catch(e) {
                loading$1.set(false);
                set$1([]);
    ...
    /* src/components/modules/Search.svelte generated by Svelte v3.5.1 */

    const file$5 = "src/components/modules/Search.svelte";
    ...
    function create_else_block$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			div.className = "not-found svelte-15eegky";
    			add_location(div, file$5, 112, 24, 2805);
    		},
    ...
    // (91:16) {#if $books.length}
    function create_if_block_2(ctx) {
    	var table, thead, tr, th0, t1, th1, t3, th2, t5, th3, t7, tbody, each_blocks = [], each_1_lookup = new Map();

    	var each_value = ctx.$books;

    	const get_key = ctx => ctx.book.id;
    	...
    	return {
    		c: function create() {
    			...
    			for (i = 0; i < each_blocks.length; i += 1) each_blocks[i].c();
    			th0.className = "svelte-15eegky";
    			add_location(th0, file$5, 94, 36, 1887);
    			th1.className = "svelte-15eegky";
    			add_location(th1, file$5, 95, 36, 1938);
    			th2.className = "svelte-15eegky";
    			add_location(th2, file$5, 96, 36, 1990);
    			th3.className = "svelte-15eegky";
    			add_location(th3, file$5, 97, 36, 2045);
    			add_location(tr, file$5, 93, 32, 1846);
    			add_location(thead, file$5, 92, 28, 1806);
    			add_location(tbody, file$5, 100, 28, 2162);
    			table.className = "svelte-15eegky";
    			add_location(table, file$5, 91, 24, 1770);
    		},
    ...
    function create_if_block_1$3(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			div.textContent = "Loading...";
    			div.className = "loading svelte-15eegky";
    			add_location(div, file$5, 88, 16, 1652);
    		},
    ...
    function create_if_block$3(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			t = text(ctx.$error);
    			div.className = "error svelte-15eegky";
    			add_location(div, file$5, 85, 8, 1566);
    		},
    ...
    // (102:32) {#each $books as book (book.id)}
    function create_each_block$1(key_1, ctx) {
    	var tr, td0, t0_value = ctx.book.title, t0, t1, td1, t2_value = ctx.book.author_name && ctx.book.author_name.join(', '), t2, t3, td2, t4_value = ctx.book.first_publish_year, t4, t5, td3, t7, dispose;
    	...
    	return {
    		...
    		c: function create() {
    			...
    			t5 = space();
    			td3 = element("td");
    			td3.textContent = "View";
    			t7 = space();
    			td0.className = "svelte-15eegky";
    			add_location(td0, file$5, 103, 40, 2316);
    			td1.className = "svelte-15eegky";
    			add_location(td1, file$5, 104, 40, 2378);
    			td2.className = "svelte-15eegky";
    			add_location(td2, file$5, 105, 40, 2477);
    			td3.className = "svelte-15eegky";
    			add_location(td3, file$5, 106, 40, 2552);
    			tr.className = "svelte-15eegky";
    			add_location(tr, file$5, 102, 36, 2271);
    			dispose = listen(td3, "click", click_handler);
    			this.first = tr;
    		},
    		...
    		p: function update(changed, new_ctx) {
    			...
    			if ((changed.$books) && t2_value !== (t2_value = ctx.book.author_name && ctx.book.author_name.join(', '))) {
    				set_data(t2, t2_value);
    			}

    			if ((changed.$books) && t4_value !== (t4_value = ctx.book.first_publish_year)) {
    ...
    function create_fragment$7(ctx) {
    	var div, form, input0, t0, input1, t1, h2, t3, dispose;

    	function select_block_type(ctx) {
    		if (ctx.$error) return create_if_block$3;
    		if (ctx.$loading) return create_if_block_1$3;
    		if (ctx.$books.length) return create_if_block_2;
    	...
    	return {
    		c: function create() {
    			...
    			input0.placeholder = "Type something to find a book";
    			input0.className = "svelte-15eegky";
    			add_location(input0, file$5, 79, 8, 1370);
    			attr(input1, "type", "submit");
    			input1.value = "Search";
    			input1.className = "svelte-15eegky";
    			add_location(input1, file$5, 80, 8, 1463);
    			form.className = "svelte-15eegky";
    			add_location(form, file$5, 78, 4, 1321);
    			h2.className = "svelte-15eegky";
    			add_location(h2, file$5, 83, 4, 1517);
    			div.className = "Search";
    			add_location(div, file$5, 77, 0, 1296);
    		...
    		p: function update(changed, ctx) {
    			if (changed.query) input0.value = ctx.query;
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	let $error, $loading, $books;

    	validate_store(books, 'books');
    	subscribe($$self, books, $$value => { $books = $$value; $$invalidate('$books', $books); });

    	const {loading, error} = books; validate_store(loading, 'loading'); subscribe($$self, loading, $$value => { $loading = $$value; $$invalidate('$loading', $loading); }); validate_store(error, 'error'); subscribe($$self, error, $$value => { $error = $$value; $$invalidate('$error', $error); });
    ...
    function create_default_slot_2(ctx) {
    	...
    	var search = new Search_1({ $$inline: true });
