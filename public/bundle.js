...
var app = (function () {
    ...
    const file$1 = "src/components/layouts/Header.svelte";
    ...
    function create_else_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			ul.className = "svelte-e0ynxz";
    			add_location(ul, file$1, 67, 8, 1310);
    		},
    		...
    		p: function update(changed, ctx) {
    			const each_value = ctx.$navigation;
    ...
    function create_if_block_1$1(ctx) {
    	...
    	return {
    		c: function create() {
    			div = element("div");
    			t = text(ctx.$error);
    			div.className = "error svelte-e0ynxz";
    			add_location(div, file$1, 65, 8, 1256);
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			div.className = "loading svelte-e0ynxz";
    			add_location(div, file$1, 63, 8, 1188);
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			if ((changed.$navigation) && t_value !== (t_value = ctx.item.title)) {
    				set_data(t, t_value);
    			}
    		},
    ...
    // (69:12) {#each $navigation as item (item.id)}
    function create_each_block(key_1, ctx) {
    	...
    	return {
    		...
    		c: function create() {
    			...
    			link.$$.fragment.c();
    			t = space();
    			li.className = "svelte-e0ynxz";
    			add_location(li, file$1, 69, 16, 1381);
    			this.first = li;
    		},
    		...
    		p: function update(changed, ctx) {
    			var link_changes = {};
    			if (changed.$navigation) link_changes.to = ctx.item.href;
    			if (changed.$$scope || changed.$navigation) link_changes.$$scope = { changed, ctx };
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			nav = element("nav");
    			if_block.c();
    			nav.className = "svelte-e0ynxz";
    			add_location(nav, file$1, 61, 0, 1155);
    		},
    ...
    const file$2 = "src/components/layouts/Default.svelte";
    ...
    const file$3 = "src/components/pages/Home.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h1, file$3, 7, 3, 81);
    			p.className = "svelte-8lte3m";
    			add_location(p, file$3, 8, 3, 124);
    			div.className = "Home";
    			add_location(div, file$3, 6, 0, 59);
    		},
    ...
    const file$4 = "src/components/pages/Search.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$4, 6, 0, 38);
    		},
